var intnames = [
    [
        ename = "DOANYA",
        pname = "Doanya",
        message = "Hello Doanya. I'm Sean. You're stuck in this hospital too? You've heard about the murder, right? <button onclick='intmes(\"YES-MUR\")' opt>YES</button><button onclick='intmes(\"YES-MUR\")>NO</button>"
    ],
    [
        ename = "ETHAN",
        pname = "Ethan",
        message = "Hello. I'm Sean. I guess you're stuck in this hospital too, which is also the place where Declan died. We  <span color='red'>need</span> to find the killer, and at the same escape the hospital. Are you up for it? <button opt onclick='intmes(\"OKAY-1\")'>Yes</button>"
    ],
    [
        ename = "TAKIRA",
        pname = "Takira",
    ...
    [
        ename = "KIRK",
        pname = "KJ",
        message = "Hello. I'm Sean. I take it that you've heard about the murder of Declan, and are stuck in the hospital too. We  <span color='red'>need</span> to find the killer, AND escape this hospital. Before we start, would you rather me call you Kirk or KJ?<button opt onclick='intmes(\"CALL-KJ\")'>KJ</button><button opt onclick='intmes(\"CALL-KIRK\")'>Kirk</button>"
    ],
    [
        ename = "COURTNEY",
        pname = "Courtney",
    ...
    [
        ename = "WILLIAM",
        pname = "Penn",
        message = "Hello. I'm Sean. I guess you're stuck in this hospital too, which is also the place where Declan died. We  <span color='red'>need</span> to find the killer, and at the same escape the hospital. I've heard a lot of creepy stories about this place. Are you up for it? <button opt onclick='intmes(\"OKAY-1\")'>Yes</button>"
    ],
    [
        ename = "SEAN",
        pname = "Sean",
    ...
    [
        ename = "STEVE",
        pname = "Mr. Roth",
        message = "Hello Mr. Roth. I'm Sean. I guess you're stuck in this hospital too, which is also the place where Declan died. We  <span color='red'>need</span> to find the killer, and at the same escape the hospital. I've heard a lot of creepy stories about this place. Are you up for it? <button opt onclick='intmes(\"OKAY-1\")'>Yes</button>"
    ],
    [
        ename = "STEVE",
        pname = "Mr. Roth",
...
function intmes2(type){
    ...
    } else if (type=="YES-CLASS"){
        return "Okay, then you probably spelled your own name wrong. Please put it in again."
    } else if (type=="NO-CLASS"){
        notIn71 = true;
        return "Okay, enter your first name into the box again.";
    }
}
...
function goName(){
    if(ename=="no-name" ){
        ...
        document.getElementById("ex").style.height = "35.3%";
        document.getElementById("ex").innerHTML = "I'm sorry, but I don't know who that is. Maybe check if you spelled your name incorrectly. Otherwise, are you a teacher or student of the Science class - Science 7-1? <button opt onclick='intmes(\"YES-CLASS\")'>Yes</button><button opt onclick='intmes(\"NO-CLASS\")'>No</button>"
    } else if(notIn71){
        document.getElementById("ex").innerHTML = "Hello. I'm Sean. I guess you're stuck in this hospital too, which is also the place where Declan died. We  <span color='red'>need</span> to find the killer, and at the same escape the hospital. I've heard a lot of creepy stories about this place. Are you up for it? <button opt onclick='intmes(\"OKAY-1\")'>Yes</button>";
        document.getElementById("ex").style.bottom = "0vw";
